...
function fetch_banks() {
    var banks = ['DATASCIENCE', 'GO', 'CLOUD COMPUTING', 'AWS', 'DEVOPS', 'C++'];
    ...
    acc.innerHTML = accno;
    cus.innerHTML = "CNO : " + String(cno);
    var src = "";
    switch (bno) {
        case 0:
            src = "img/datascience.jpeg";
            break;
        case 1:
            src = "img/go.webp";
            break;
        case 2:
            src = "img/cloudcomputing.jpg";
            break;
        case 3:
            src = "img/aws.png";
            break;
